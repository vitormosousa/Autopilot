Arduino Seatalk autopilot control
---------------------------------------------------------


<br>
SeaTalk is a simple interface for networking Raymarine/Autohelm marine equipment so that all devices of a ship can exchange and share their data 

[SeaTalk Technical Reference](http://www.thomasknauf.de/seatalk/)

A presente aplicação permite atarves de USB

- extrair mensagens nmea0183.
  - a rudder, compass, estado do piloto automatico 
- fornecer mensagens nmea0183.
  - angulo e velocidade do vento aparente.
  - controlo do autopilot -/+ 1/10  Auto/Standby/Wind
- Interface Node-red dashboard.

Configura a livraria [NMEAParser](https://github.com/Glinnes/).

Modifica a livraria [SoftwareSerial9](https://github.com/addibble/SoftwareSerial9) de modo a só activar a porta de escrita quando possivel e necessario (half duplex).

Compilado com vscode
